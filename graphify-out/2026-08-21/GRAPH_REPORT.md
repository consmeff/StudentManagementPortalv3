...
## Communities (155 total, 75 thin omitted)
...
Cohesion: 0.17
Nodes (15): formstepDTO, Countries, CountryDTO, States, StatesDTO, CertificateOfBirth, LGA, OLevelResult (+7 more)
...
Cohesion: 0.15
Nodes (16): AcceptanceFee, PasswordChangePayload, StudentFeePartPaymentConfig, StudentFeePartPaymentEntry, StudentFeePartPaymentMode, StudentFeePaymentPayload, StudentFeePlan, StudentSchoolFeePaymentStatus (+8 more)
...
Cohesion: 0.14
Nodes (16): ACADEMIC_HISTORY_ATTEMPT_OPTIONS, ACADEMIC_HISTORY_AWAITING_RESULT_OPTION, ACADEMIC_HISTORY_RULES, AcademicHistory, ExamRecord, TAcademicHistory, formatDateOnly(), padDatePart() (+8 more)
...
Cohesion: 0.12
Nodes (11): AppComponent, Component, appConfig, GlobalLoadingComponent, Component, appRoutes, INACTIVITY_PROVIDERS, jwtInterceptor() (+3 more)
...
Cohesion: 0.17
Nodes (7): LGA, RegistrantDataDTO, ALL_ROLES, RoleId, UserToken, RegStoreService, Injectable
...
Cohesion: 0.18
Nodes (11): @angular/animations, @angular/forms, chartjs-adapter-date-fns, @ngrx/signals, dependencies, @angular/animations, @angular/forms, chartjs-adapter-date-fns (+3 more)
...
Cohesion: 0.07
Nodes (26): RETURNING_STUDENT_DISABILITY_LABEL, RETURNING_STUDENT_PAYMENT_LABEL, RETURNING_STUDENT_PROFILE_CONFIG, RETURNING_STUDENT_STATUS_LABEL, AvailableCourse, AvailableCoursesResponse, CourseInfo, flattenRegisteredCoursesResponse() (+18 more)
...
Cohesion: 0.15
Nodes (10): NgModule, Program, sidebarStateDTO, AdmittedAcceptancePaymentComponent, Component, TraceabilityModule, AuthSessionStore, Injectable (+2 more)
...
Cohesion: 0.29
Nodes (6): Payment Row Template, Receipt Download Action, StatusIndicatorComponent, StatusTone, Component, Input
...
### Community 103 - "admission.dto.ts"
Cohesion: 0.18
Nodes (8): AppInitResponse, AppInitResponseDTO, Convert, DepartmentsDTO, Faculty, Level, OpenApplicationDTO, Session

### Community 123 - ".applyStudentProfileSnapshot"
Cohesion: 0.33
Nodes (3): buildEmptyAddress(), mapGuardianAddress(), mapStudentAddress()
...
- **What is the exact relationship between `Wide Horizontal Logo Wordmark (SVG-wrapped raster, 1358x311)` and `Institution Identity: College of Nursing Sciences, Muslim Medical Foundation`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `ApplicationService` connect `ApplicationService` to `payment.component.ts`, `programComponent`, `admissionform.component.ts`, `ReturningPaymentComponent`, `PaymentComponent`, `ApplicationSummaryComponent`, `PreRegistrationDataDTO`, `StudentResultsResponse`, `.toRecord`, `application.service.ts`, `.normalizeStudentFeePlansResponse`, `UploadFormComponent`, `application/payment.data.ts`, `auth.service.ts`, `pending-payment-flow.component.ts`, `applicationsummary.component.ts`, `.normalizeStudentHostelOption`, `RegistrantDataDTO`, `app.sidebar.ts`, `returning-flow.service.ts`, `AuthSessionStore`, `StudentCgpaTrendResponse`?**
